...
\begin{itemize}
	\item Enhanced technical skills by completing online courses in Spring Boot and Angular to stay current with industry trends.	
	\item Developed proof-of-concept (PoC) projects to explore potential solutions, demonstrating initiative and technical competence.
\end{itemize}
...
\subsection{Organic Bazaar: An online platform for organic products}
\textit{Java, Spring Boot, Angular, Microservices}
\hfill
\href{https://github.com/jatinkumar-me/organic-bazaar}{ \faLink }
\begin{itemize}
	\item Implemented a POC solution for users to effortlessly buy organic fruits, vegetables, and pulses on orders as well as monthly subscription services. 
\end{itemize}
