...
Driven \textit{Full Stack Developer}. Ready to Elevate Career in a Fast-Paced, Small/Mid-level, Product Based (preferrably User-Facing) Company — Adaptable and Driven to Learn, Grow, and Contribute.
...
\vspace{-10pt}
\subsubsection*{Tools}
Git, GitHub, VS-Code, Eclipse, Postman, Linux
